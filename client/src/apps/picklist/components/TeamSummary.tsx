    ...
    return (
        <div className='flex flex-row '>
                    ...
                    Object.entries(teamData.Comments)
                        ...
                        .map(
                            ([comment, count]) =>
                                count > 0 && (
                                    <p
                                        className={` text-md m-2 max-w-fit rounded-lg border bg-slate-600 pl-2 py-1 text-zinc-100 saturate-[75%]  ${commentToColor(comment)} `}>
            ...
            <div>
                ...
                <p className='indent-3'>
                    Chain traversal:{' '}
                    {teamPitData?.capabilities.chainTraversal ? 'Yes' : 'No'}
                </p>
                ...
                <p className='indent-3'>
                    Speaker:{' '}
                    {teamPitData?.preference.speakerPerfer ? 'Yes' : 'No'}
                </p>
                <p className='indent-3'>
