...
function ScouterTable({scouters}:{ scouters: StatusReport[]}) {
    ...
    const sortedScouter = Object.fromEntries((['red_1', 'red_2', 'red_3', 'blue_1', 'blue_2', 'blue_3', 'red_ss', 'blue_ss']satisfies (RobotPosition|SuperPosition)[]).map (robotPosition => [robotPosition, (
